...
如此，我们统一了概念，接下来解释下什么是 prototype、为什么会有 prototype... 等等
...
关于 constructor ，我们能衍生出 constructor 的始祖 Function （内置构造函数）与 原型的始祖 Object.prototype 的鸡生蛋和蛋生鸡问题，具体可看这篇——[JavaScript 中的始皇](./Function&Object鸡蛋问题.md)
...
从发展的角度看，Object.create 是 ES5 出现，但它不满足两个对象设置原型时，ES6 就提供了新的方法——Object.setPrototypeOf。但无论如何，它们都是后来因为个别需求而新增的 API，无法和 JavaScript 一开始采用的隐式继承相媲美
...
function create(proto) {
  ...
  // 所以 new F() 后的实例的的[[Prototype]]指向 F.prototype，也就是proto
}
```
