...
JavaScript 的继承是基于原型实现，在前文 [原型](./原型.md) 里，笔者讲到了原型继承，并详细介绍了显式原型继承和隐式原型继承的各自两种方法。现在我们以继承的视角切入，并以案例的形式来介绍 8 种常见的 JavaScript 继承方法

在看这篇之前，建议先看[new](./new.md) ，或者记住一句话，new 关键字所形成的原型链关系是：`实例.__proto__ === 构造函数.prototype`
...
![image-20220726141013694](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220726141013694.png)
...
![借用构造函数继承原型链结构](https://s2.loli.net/2022/07/26/oLFHSahcRZXPOpE.png)
...
![image-20220726145225158](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220726145225158.png)
...
![image-20220728141121552](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220728141121552.png)
...
![image-20220727135554652](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220727135554652.png)
...
![image-20220727105732854](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220727105732854.png)
...
![image-20220728094130940](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220728094130940.png)

原型链关系图：

![image-20220727145130420](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220727145130420.png)
...
![image-20220728103951253](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220728103951253.png)

但如果要做全的话

![image-20220728103516527](C:/Users/hanbo/AppData/Roaming/Typora/typora-user-images/image-20220728103516527.png)
