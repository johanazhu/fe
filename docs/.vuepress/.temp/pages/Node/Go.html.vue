<template><h1 id="go" tabindex="-1"><a class="header-anchor" href="#go" aria-hidden="true">#</a> Go</h1>
<h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>
<ul>
<li><a href="http://www.topgoer.com/" target="_blank" rel="noopener noreferrer">学习go<ExternalLinkIcon/></a></li>
...
<p>其次安装go的插件</p>
<p><img src="https://i.loli.net/2021/06/04/CXq24MKnDmrRuVF.png" alt="VScode安装插件"></p>
</template>
