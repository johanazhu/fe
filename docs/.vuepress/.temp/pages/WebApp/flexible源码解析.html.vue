<template><h1 id="flexible源码解析" tabindex="-1"><a class="header-anchor" href="#flexible源码解析" aria-hidden="true">#</a> flexible源码解析</h1>
<p>amlib-flexible 源码总共44行</p>
...
<p>2.0 新的（2019）</p>
<p>两个问题存在，判断设备支不支持 0.5px，如果支持，就在 body 上面添加一个名为 hairlines 的class，所以我们的代码这样写</p>
