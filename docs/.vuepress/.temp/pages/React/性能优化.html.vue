...
<p>如果做好一道，就喊一次：我做了XX菜，还有几道菜，其他人喊好的。其他人在这其中就是没必要说的，按照React 的说法，就是没必要渲染</p>
<p>废话不多说，亮代码：</p>
...
<span class="token keyword">const</span> <span class="token function-variable function">App</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token punctuation">(</span>
    	<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Family</span></span> <span class="token punctuation">/></span></span>
    <span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br></div></div><p>memo 就是减少组件的没必要的渲染，做浅对比</p>
<p>函数式性能优化</p>
<p>​	主要是 hooks</p>
...
<ul>
<li><a href="https://zhuanlan.zhihu.com/p/74229420" target="_blank" rel="noopener noreferrer">浅谈React性能优化的方向<ExternalLinkIcon/></a></li>
<li><a href="https://liyang0207.github.io/2018/10/11/%E3%80%8A%E8%AE%B0%E5%BF%86%E5%8C%96%E6%8A%80%E6%9C%AFmemoize-one%E3%80%8B/" target="_blank" rel="noopener noreferrer">记忆化技术memoize-one<ExternalLinkIcon/></a></li>
...
<li><a href="https://github.com/fi3ework/blog/issues/15" target="_blank" rel="noopener noreferrer">React高效渲染策略<ExternalLinkIcon/></a></li>
<li><a href="https://mp.weixin.qq.com/s?__biz=MzkwODIwMDY2OQ==&amp;mid=2247488384&amp;idx=1&amp;sn=72499c2347a8b0bd43192942ab608d92&amp;source=41#wechat_redirect" target="_blank" rel="noopener noreferrer">如何全方位优化你的超大型React应用 【原创精读】<ExternalLinkIcon/></a></li>
<li><a href="https://mp.weixin.qq.com/s?__biz=MzkwODIwMDY2OQ==&amp;mid=2247488326&amp;idx=1&amp;sn=3c00c2ee434e95df1795e9bdebf2ede6&amp;source=41#wechat_redirect" target="_blank" rel="noopener noreferrer">干货：深入了解React 渲染原理及性能优化<ExternalLinkIcon/></a></li>
<li><a href="https://mp.weixin.qq.com/s?__biz=MzI1ODE4NzE1Nw==&amp;mid=2247487358&amp;idx=1&amp;sn=99298d0c25e9906c82fe01cc29f59950&amp;chksm=ea0d4584dd7acc92d2e26299feeb5b59b515bb0f866a415688b9d64fc566580a1b8f53be411b&amp;mpshare=1&amp;scene=1&amp;srcid=&amp;sharer_sharetime=1582717186505&amp;sharer_shareid=778ad5bf3b27e0078eb105d7277263f6#rd" target="_blank" rel="noopener noreferrer">可能你的react函数组件从来没有优化过<ExternalLinkIcon/></a></li>
...
<li><a href="https://mp.weixin.qq.com/s/x3Eqd4D8CDkm0ZTd7XCUwQ" target="_blank" rel="noopener noreferrer">「react进阶」react开发者的不得不知道的八条优化建议<ExternalLinkIcon/></a></li>
<li><a href="https://jishuin.proginn.com/p/763bfbd5d4d0" target="_blank" rel="noopener noreferrer">这可能是全网最全的react性能优化知识锦集<ExternalLinkIcon/></a></li>
<li><a href="https://cloud.tencent.com/developer/news/833663" target="_blank" rel="noopener noreferrer">从源码中来，到业务中去，React性能优化终极指南<ExternalLinkIcon/></a></li>
...
<li><a href="https://www.zhihu.com/question/390974405/answer/2001530387" target="_blank" rel="noopener noreferrer">新版react中，usecallback和usememo是不是值得大量使用？<ExternalLinkIcon/></a></li>
</ul>
</template>
