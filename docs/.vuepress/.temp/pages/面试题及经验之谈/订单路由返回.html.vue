<template><h1 id="订单路由返回" tabindex="-1"><a class="header-anchor" href="#订单路由返回" aria-hidden="true">#</a> 订单路由返回</h1>
<h2 id="访问上一页url地址" tabindex="-1"><a class="header-anchor" href="#访问上一页url地址" aria-hidden="true">#</a> 访问上一页url地址</h2>
<p>传统做法：document.referrer</p>
<p>https://www.zhangxinxu.com/wordpress/2017/02/js-page-url-document-referrer/
但是在单页面中不支持
...
结合以上两种做法：采用第二种，再点击”确认返回“按钮时，history.goBack() 返回至上页面，并关闭弹框安全页面history出栈</p>
</template>
